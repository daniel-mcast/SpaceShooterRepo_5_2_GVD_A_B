...
public class Player : MonoBehaviour
{
    ...
    void CalculateMovement()
    {
        ...
        //if the player's y position is great or equal to 0
        ...
        // }
        //Vector3(tranform.position.x,Mathf.Clamp(),0)
        transform.position = new Vector3(transform.position.x,Mathf.Clamp(transform.position.y,-3.8f,0),0);



        //check if the player went past 11.3f on the x  axis
        if(transform.position.x > 11.3f)
        {
            //teleport the player to -11.3f on thex  axis
            transform.position = new Vector3(-11.3f,transform.position.y,0);
        }
        //check if the player went past -11.3f on the x axis
        else if(transform.position.x < -11.3f)
        {
            //teleport the player to 11.3f on the x axis
            transform.position = new Vector3(11.3f,transform.position.y,0);
        }
    }
